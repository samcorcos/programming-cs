...
To quote Jeff Atwood's take, this means that "the act of programming seems literally unteachable to a sizable subset of incoming computer science students." This is not just numbers telling a story; every computer science educator I've asked has had some similar hunch that things just haven't quite clicked for some sizable portion of their class. I've seen it first hand with students entering a course with the same who invested dozens of hours in a text editor and in office hours on an assignment in my recitation attending every office hour available to them,  at the University of Pennsylvania where enrollment numbers for the three-course intro sequence would fall by 30 to 50% from one to the next and students would come into the course with the same background but see I've seen it first hand. At the University of Pennsylvania, enrollment in all three semesters introductory computer science classes would typically fall 20% or more by the first exam.

  introductory computer science sequence At the University of Pennsylvania, enrollment is cut in half between the first and second semester <insert stats on first semester vs 2nd, 3rd semester programming course enrollment>

Even if we disagree with the notion that many people just don't grasp programming as well as others, Dan Bricklin, a decorated technologist best known for inventing the electronic spreadsheet, offers another take:
...
Instead of splitting people into performance-based buckets, he considers motivations and complexity and suggests that maybe there's some self-selection going on. Maybe some people just don't want to invest heavily in something for which they see correspondingly little use.
